        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              {["Features", "Security", "Team", "Enterprise", "Customer Stories"].map((item) => (
                <li key={item}>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              {["Documentation", "Guides", "API Status", "Support", "Contact"].map((item) => (
                <li key={item}>
                  <a href="#" className="text-sm text-gray-600 hover:text-purple-600 transition-colors">
                    {item}
                  </a>
            ...
            <form className="mt-4">
              <div className="flex max-w-md gap-x-4">
                <input
                  ...
                  className="min-w-0 flex-auto rounded-md border border-gray-200 bg-white/50 px-3.5 py-2 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-purple-600 sm:text-sm sm:leading-6"
                />
